...
#[derive(Clone)]
pub struct GetVoiceSettingsV1VoicesVoiceIdSettingsGetRequest<'a> {
    pub(crate) http_client: &'a ElevenLabsClient,
    pub voice_id: String,
    pub xi_api_key: Option<String>,
}
impl<'a> GetVoiceSettingsV1VoicesVoiceIdSettingsGetRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for GetVoiceSettingsV1VoicesVoiceIdSettingsGetRequest<'a> {
