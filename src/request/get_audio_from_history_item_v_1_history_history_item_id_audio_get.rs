...
#[derive(Clone)]
pub struct GetAudioFromHistoryItemV1HistoryHistoryItemIdAudioGetRequest<'a> {
    pub(crate) http_client: &'a ElevenLabsClient,
    pub history_item_id: String,
    pub xi_api_key: Option<String>,
}
impl<'a> GetAudioFromHistoryItemV1HistoryHistoryItemIdAudioGetRequest<'a> {
...
impl<'a> ::std::future::IntoFuture
    for GetAudioFromHistoryItemV1HistoryHistoryItemIdAudioGetRequest<'a>
{
