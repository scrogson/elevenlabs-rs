...
#[derive(Clone)]
pub struct TextToSpeechV1TextToSpeechVoiceIdStreamPostRequest<'a> {
...
impl<'a> TextToSpeechV1TextToSpeechVoiceIdStreamPostRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for TextToSpeechV1TextToSpeechVoiceIdStreamPostRequest<'a> {
