use super::{InvoiceResponseModel, TtsModelResponseModel};
use serde::{Deserialize, Serialize};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ExtendedSubscriptionResponseModel {
    ...
    pub next_invoice: InvoiceResponseModel,
...
impl std::fmt::Display for ExtendedSubscriptionResponseModel {
